...
var motherShipHealth = 25;  //number of hits it takes to destroy mother ship
...
Missile.prototype.checkForMotherShipHit = function(mothership){
    if ((this.x >= (motherShip.x - 60) && this.x <= (motherShip.x + 60)) &&
        (this.y >= (motherShip.y - 35) && this.y <= (motherShip.y + 35))) {
        this.y = -100;
        motherShipHealth--;
        }
};
...
Missile.prototype.move = function() {
    ...
    for(var i = 0; i < ships.length; i++){
        ...
        this.checkForMotherShipHit(Missile);
    }
...
var motherShip = new motherShip(60,45,2);
